          ...
          {!userInfo && (
            <>
              <NavbarItem className="hidden lg:flex">
                <Button
                  onPress={onOpen}
                  className="bg-gradient-to-r from-purple-400 to-violet-600 text-white font-semibold rounded-xl shadow-md hover:scale-105 transition-transform duration-300"
                >
                  Login
                </Button>
              </NavbarItem>
              <NavbarItem>
                <Button
                  as={Button}
                  onPress={onOpen}
                  className="bg-gradient-to-r from-pink-500 to-red-500 text-white font-semibold rounded-xl shadow-md hover:scale-105 transition-transform duration-300"
                >
                  Sign Up
                </Button>
              </NavbarItem>
